...
from config import BOT_TOKEN, BOT_USERNAME, CHANNEL_ID, ADMIN_ID, RESTART_INTERVAL_HOURS, PORT
...
# ==========================
# [DB] БЕЗОПАСНОЕ ЗАКРЫТИЕ
# ==========================
async def graceful_shutdown():
    print("[DB] Graceful shutdown started...")
    try:
    ...
    print("[OK] Graceful shutdown finished")
...
async def on_startup():
    ...
    print(f"[INFO] Next auto-restart in {RESTART_INTERVAL_HOURS} hours")
